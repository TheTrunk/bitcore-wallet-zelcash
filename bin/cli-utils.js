...
Utils.getClient = function(args, opts, cb) {
  ...
  var host = args.host || process.env['BWS_HOST'] || 'https://bws.zelcash.online/';
...
Utils.configureCommander = function(program) {
  program
    ...
    .option('-h, --host <host>', 'Bitcore Wallet Service URL (eg: https://bws.zelcash.online/bws/api')
...
Utils.renderAmount = function(satoshis, coin, opts) {
  ...
  var coin = coin || 'ZEL';
  var u = Utils.COIN[coin] || Utils.COIN.ZEL;

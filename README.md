...
Zelcash port from bitcoin's [bitcore-wallet](https://github.com/bitpay/bitcore-wallet)).
A simple Command Line Interface Wallet using [Bitcore Wallet Service Zelcash](https://github.com/TheTrunk/bitcore-wallet-service-zelcash) and its *official* client lib, [bitcore-wallet-client-zelcash](https://github.com/TheTrunk/bitcore-wallet-client-zelcash)

This can be used to operate Zelcash wallets.
...
# git clone https://github.com/TheTrunk/bitcore-wallet-service-zelcash.git bws
...
# Spend coins. Amount can be specified in ZEL, bit or sat (default)
...
# You can use 1000bit or 0.0001ZEL or 100000sat. (Set BIT_UNIT to ZEL/sat/bit to select output unit).
